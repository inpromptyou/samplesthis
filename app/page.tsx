        ...
        <section className="pb-16 sm:pb-24 px-5 sm:px-6">
          <div className="max-w-[1000px] mx-auto">
            <div className="flex items-center justify-between mb-5 sm:mb-6">
              ...
              <Link href="/jobs" className="text-[13px] text-[var(--text-dim)] hover:text-[var(--text)] transition-colors flex items-center gap-1">
                View all
          ...
          <div className="flex items-center marquee whitespace-nowrap">
            {[...Array(2)].flatMap(() =>
              ["Cursor", "Bolt", "Replit", "Lovable", "v0", "Windsurf", "Claude", "ChatGPT", "Vercel", "Supabase"].map((t, i) => (
                <span key={`${t}-${i}`} className="mx-6 sm:mx-10 h text-[12px] sm:text-[13px] font-semibold text-black/25 uppercase tracking-[0.12em]">{t}</span>
              ))
            )}
          </div>
        </section>
